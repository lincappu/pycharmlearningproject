...
# format
# print('my name is {0} my age is {1}'.format('egon', 18))
# print('my name is {name} my age is {age}'.format(age='18', name='egon'))
#
# msg = 'li xin ni hao'
# print(msg.find('ni'))  # 从左向右找，找到后返回第一个字符的索引
# print(msg.find('fsdf'))
# print(msg.index('ni'))  # 如果没有 则直接报错。
#
# msg = 'hello world'
# print(msg.count('l', 0, 3))  # 返回的是个数
#
# msg = 'a:a:b:c:d:e'
# l = msg.split(':')
# l.append('f')  #默认是添加到最后
...
# print(msg.ljust(18,'#'))
# print(msg.rjust(18,'#'))
# print(msg.zfill(18)) # 用0 填充


# expangtable  制表符的个数
# msg = 'abc\tdefs'
# print(msg)
# print(msg.expandtabs(5))
...
# print(msg.isdecimal())  #只能判断 bytes 类型的
...
# 列表、词典这种都是可变类型，所以都是不能作为 key 的。元组就可以作为 key
# user = {
#     'name': 'egon',
#     'hobbies': ['play', 'sleep'],
#     'age': 18,
...
# p rint(s1.isdisjoint(s2)) # 没有交集则返回 true
